...
>More details about the styles and patterns used in this app can be found 
in the [Angular Style Guide](https://github.com/johnpapa/angularjs-styleguide) and my [Angular Patterns: Clean Code](http://jpapa.me/ngclean) course at [Pluralsight](http://pluralsight.com/training/Authors/Details/john-papa) and working in teams.
...
The descriptions below are for HotTowel Angular starter project, this will be updated soon with 
descriptions of the Hello Test project.
