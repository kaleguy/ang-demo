angular.module('angular-collapse', []).directive('ngCollapse', ['$animate', '$timeout', function ($animate, $timeout) {
	return {
		link: function (scope, element, attrs) {
			...
			function expand() {
				...
				element.addClass('in').attr('aria-expanded', true).attr('aria-hidden', false);
			...
			function collapse() {
				...
				// apply the css needed for the transition
				element.css(css).removeClass('in') // remove the in class before animating to prevent flicker at end (collapsing class has display: block)
...
//# sourceMappingURL=angular-collapse-compiled.js.map