...
var config = {
  'base': {
    'entryLinks': ['<% if (name == "templateSettings" || !/^(?:methods|properties|seq)$/i.test(category)) {' + 'print("[&#x24C3;](https://www.npmjs.com/package/lodash." + name.toLowerCase() + " \\"See the npm package\\")")' + '} %>'],
...
//# sourceMappingURL=build-doc-compiled.js.map