(function () {
  ...
  QUnit.test('String comparator.', function (assert) {
    assert.expect(1);
    var collection = new Backbone.Collection([{ id: 3 }, { id: 1 }, { id: 2 }], { comparator: 'id' });
  ...
  QUnit.test('Underscore methods', function (assert) {
    ...
    assert.deepEqual(wrapped.filter(function (o) {
      return o.id % 2 === 0;
    }).map(function (o) {
      return o.id * 2;
    }).value(), [4, 0]);
  ...
  QUnit.test('Underscore methods with object-style and property-style iteratee', function (assert) {
    ...
    var coll = new Backbone.Collection([{ a: 1, b: 1 }, { a: 2, b: 1, c: 1 }, { a: 3, b: 1 }, model]);
  ...
  QUnit.test('#574, remove its own reference to the .models array.', function (assert) {
    assert.expect(2);
    var collection = new Backbone.Collection([{ id: 1 }, { id: 2 }, { id: 3 }, { id: 4 }, { id: 5 }, { id: 6 }]);
