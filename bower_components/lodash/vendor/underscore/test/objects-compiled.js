(function () {
  ...
  QUnit.test('keys', function (assert) {
    ...
    var troubleKeys = ['constructor', 'valueOf', 'hasOwnProperty', 'toString', 'toLocaleString', 'propertyIsEnumerable', 'isPrototypeOf', '__defineGetter__', '__defineSetter__', '__lookupSetter__', '__lookupGetter__'].sort();
  ...
  QUnit.test('allKeys', function (assert) {
    ...
    var troubleKeys = ['constructor', 'valueOf', 'hasOwnProperty', 'toString', 'toLocaleString', 'propertyIsEnumerable', 'isPrototypeOf'].sort();
  ...
  QUnit.test('isEqual', function (assert) {
    ...
    assert.ok(!_.isEqual(new String('Curly'), { toString: function () {
        return 'Curly';
    ...
    assert.ok(!_.isEqual(new Number(63), { valueOf: function () {
        return 63;
  ...
  if (typeof Int8Array !== 'undefined') {
    QUnit.test('#1929 Typed Array constructors are functions', function (assert) {
      _.chain(['Float32Array', 'Float64Array', 'Int8Array', 'Int16Array', 'Int32Array', 'Uint8Array', 'Uint8ClampedArray', 'Uint16Array', 'Uint32Array']).map(_.propertyOf(typeof GLOBAL != 'undefined' ? GLOBAL : window)).compact().each(function (TypedArray) {
