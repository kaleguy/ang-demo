(function () {
  ...
  QUnit.test('delay', function (assert) {
    ...
    setTimeout(function () {
      assert.ok(delayed, 'delayed the function');done();
    }, 150);
  });
  ...
  QUnit.test('defer', function (assert) {
    ...
    _.delay(function () {
      assert.ok(deferred, 'deferred the function');done();
    }, 50);
  });
  ...
  QUnit.test('throttle', function (assert) {
    ...
    _.delay(function () {
      assert.equal(counter, 2, 'incr was throttled');done();
    }, 64);
  });
  ...
  QUnit.test('throttle arguments', function (assert) {
    ...
    _.delay(function () {
      assert.equal(value, 3, 'updated to latest value');done();
    }, 96);
  });
  ...
  QUnit.test('throttle twice', function (assert) {
    ...
    throttledIncr();throttledIncr();
    _.delay(function () {
      assert.equal(counter, 2, 'incr was called twice');done();
    }, 64);
  });
  ...
  QUnit.test('throttle cancel', function (assert) {
    ...
    _.delay(function () {
      assert.equal(counter, 3, 'incr was throttled');done();
    }, 64);
  });
  ...
  QUnit.test('throttle cancel with leading: false', function (assert) {
    ...
    _.delay(function () {
      assert.equal(counter, 0, 'incr was throttled');done();
    }, 64);
  });
  ...
  QUnit.test('debounce', function (assert) {
    ...
    _.delay(function () {
      assert.equal(counter, 1, 'incr was debounced');done();
    }, 96);
  });
  ...
  QUnit.test('debounce cancel', function (assert) {
    ...
    _.delay(function () {
      assert.equal(counter, 0, 'incr was not called');done();
    }, 96);
  });
  ...
  QUnit.test('debounce asap cancel', function (assert) {
    ...
    _.delay(debouncedIncr, 48);
    _.delay(function () {
      assert.equal(counter, 2, 'incr was debounced');done();
    }, 128);
  });
