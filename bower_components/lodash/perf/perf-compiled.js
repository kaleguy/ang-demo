;(function () {
  ...
  /** Load lodash. */
  var lodash = root.lodash || (root.lodash = (lodash = load(filePath) || root._, lodash = lodash._ || lodash, lodash.runInContext ? lodash.runInContext(root) : lodash, lodash.noConflict()));

  /** Load Underscore. */
  var _ = root.underscore || (root.underscore = (_ = load('../vendor/underscore/underscore.js') || root._, _._ || _));

  /** Load Benchmark.js. */
  var Benchmark = root.Benchmark || (root.Benchmark = (Benchmark = load('../node_modules/benchmark/benchmark.js') || root.Benchmark, Benchmark = Benchmark.Benchmark || Benchmark, Benchmark.runInContext(lodash.extend({}, root, { '_': lodash }))));
  ...
  function basename(filePath, extension) {
    ...
    return arguments.length < 2 ? result : result.replace(RegExp(extension.replace(reSpecialChars, '\\$&') + '$'), '');
  }
   ...
   */
  function run() {
    fbPanel = (fbPanel = root.document && document.getElementById('FirebugUI')) && (fbPanel = (fbPanel = fbPanel.contentWindow || fbPanel.contentDocument).document || fbPanel) && fbPanel.getElementById('fbPanel1');
  ...
  suites.push(Benchmark.Suite('`_(...).map(...).filter(...).take(...).value()`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.assign`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.assign` with multiple sources').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.bind` (slow path)').add(buildName, {
  ...
  suites.push(Benchmark.Suite('bound call with arguments').add(buildName, {
  ...
  suites.push(Benchmark.Suite('bound and partially applied call with arguments').add(buildName, {
  ...
  suites.push(Benchmark.Suite('bound multiple times').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.bindAll`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.clone` with an array').add(buildName, '\
        lodash.clone(numbers)').add(otherName, '\
        _.clone(numbers)'));

  suites.push(Benchmark.Suite('`_.clone` with an object').add(buildName, '\
        lodash.clone(object)').add(otherName, '\
        _.clone(object)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.compact`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.countBy` with `callback` iterating an array').add(buildName, '\
        lodash.countBy(numbers, function(num) { return num >> 1; })').add(otherName, '\
        _.countBy(numbers, function(num) { return num >> 1; })'));

  suites.push(Benchmark.Suite('`_.countBy` with `property` name iterating an array').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.countBy` with `callback` iterating an object').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.defaults`').add(buildName, '\
        lodash.defaults({ "key2": 2, "key6": 6, "key18": 18 }, object)').add(otherName, '\
        _.defaults({ "key2": 2, "key6": 6, "key18": 18 }, object)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.difference`').add(buildName, '\
        lodash.difference(numbers, twoNumbers, fourNumbers)').add(otherName, '\
        _.difference(numbers, twoNumbers, fourNumbers)'));

  suites.push(Benchmark.Suite('`_.difference` iterating 20 and 40 elements').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.difference` iterating 200 elements').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.each` iterating an array').add(buildName, '\
        var result = [];\
  ...
  suites.push(Benchmark.Suite('`_.each` iterating an object').add(buildName, '\
        var result = [];\
  ...
  suites.push(Benchmark.Suite('`_.every` iterating an array').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.every` iterating an object').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.filter` iterating an array').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.filter` iterating an object').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.filter` with `_.matches` shorthand').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.filter` with `_.matches` predicate').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.find` iterating an array').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.find` iterating an object').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.find` with `_.matches` shorthand').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.flatten`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.flattenDeep` nested arrays of numbers').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.flattenDeep` nest arrays of objects').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.flowRight`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('composed call').add(buildName, {
    'fn': 'lodashComposed(0)',
    'teardown': 'function flowRight(){}'
  }).add(otherName, {
    'fn': '_composed(0)',
  ...
  suites.push(Benchmark.Suite('`_.functions`').add(buildName, '\
        lodash.functions(lodash)').add(otherName, '\
        _.functions(lodash)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.groupBy` with `callback` iterating an array').add(buildName, '\
        lodash.groupBy(numbers, function(num) { return num >> 1; })').add(otherName, '\
        _.groupBy(numbers, function(num) { return num >> 1; })'));

  suites.push(Benchmark.Suite('`_.groupBy` with `property` name iterating an array').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.groupBy` with `callback` iterating an object').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.includes` searching an array').add(buildName, '\
        lodash.includes(numbers, limit - 1)').add(otherName, '\
        _.includes(numbers, limit - 1)'));

  suites.push(Benchmark.Suite('`_.includes` searching an object').add(buildName, '\
        lodash.includes(object, limit - 1)').add(otherName, '\
        _.includes(object, limit - 1)'));

  if (lodash.includes('ab', 'ab') && _.includes('ab', 'ab')) {
    suites.push(Benchmark.Suite('`_.includes` searching a string').add(buildName, '\
          lodash.includes(strNumbers, "," + (limit - 1))').add(otherName, '\
          _.includes(strNumbers, "," + (limit - 1))'));
  }

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.indexOf`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.intersection`').add(buildName, '\
        lodash.intersection(numbers, twoNumbers, fourNumbers)').add(otherName, '\
        _.intersection(numbers, twoNumbers, fourNumbers)'));

  suites.push(Benchmark.Suite('`_.intersection` iterating 120 elements').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.invert`').add(buildName, '\
        lodash.invert(object)').add(otherName, '\
        _.invert(object)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.invokeMap` iterating an array').add(buildName, '\
        lodash.invokeMap(numbers, "toFixed")').add(otherName, '\
        _.invokeMap(numbers, "toFixed")'));

  suites.push(Benchmark.Suite('`_.invokeMap` with arguments iterating an array').add(buildName, '\
        lodash.invokeMap(numbers, "toFixed", 1)').add(otherName, '\
        _.invokeMap(numbers, "toFixed", 1)'));

  suites.push(Benchmark.Suite('`_.invokeMap` with a function for `path` iterating an array').add(buildName, '\
        lodash.invokeMap(numbers, Number.prototype.toFixed, 1)').add(otherName, '\
        _.invokeMap(numbers, Number.prototype.toFixed, 1)'));

  suites.push(Benchmark.Suite('`_.invokeMap` iterating an object').add(buildName, '\
        lodash.invokeMap(object, "toFixed", 1)').add(otherName, '\
        _.invokeMap(object, "toFixed", 1)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.isEqual` comparing primitives').add(buildName, {
    'fn': '\
          lodash.isEqual(1, "1");\
          lodash.isEqual(1, 1)',
  ...
  suites.push(Benchmark.Suite('`_.isEqual` comparing primitives and their object counterparts (edge case)').add(buildName, {
    'fn': '\
  ...
  suites.push(Benchmark.Suite('`_.isEqual` comparing arrays').add(buildName, {
    'fn': '\
  ...
  suites.push(Benchmark.Suite('`_.isEqual` comparing nested arrays').add(buildName, {
    'fn': '\
  ...
  suites.push(Benchmark.Suite('`_.isEqual` comparing arrays of objects').add(buildName, {
    'fn': '\
  ...
  suites.push(Benchmark.Suite('`_.isEqual` comparing objects').add(buildName, {
    'fn': '\
  ...
  suites.push(Benchmark.Suite('`_.isArguments`, `_.isDate`, `_.isFunction`, `_.isNumber`, `_.isObject`, `_.isRegExp`').add(buildName, '\
        ...
        lodash.isRegExp(object)').add(otherName, '\
  ...
  suites.push(Benchmark.Suite('`_.keys` (uses native `Object.keys` if available)').add(buildName, '\
        lodash.keys(object)').add(otherName, '\
        _.keys(object)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.lastIndexOf`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.map` iterating an array').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.map` iterating an object').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.map` with `_.property` shorthand').add(buildName, '\
        lodash.map(objects, "num")').add(otherName, '\
        _.map(objects, "num")'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.max`').add(buildName, '\
        lodash.max(numbers)').add(otherName, '\
        _.max(numbers)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.min`').add(buildName, '\
        lodash.min(numbers)').add(otherName, '\
        _.min(numbers)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.omit` iterating 20 properties, omitting 2 keys').add(buildName, '\
        lodash.omit(object, "key6", "key13")').add(otherName, '\
        _.omit(object, "key6", "key13")'));

  suites.push(Benchmark.Suite('`_.omit` iterating 40 properties, omitting 20 keys').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.partial` (slow path)').add(buildName, {
  ...
  suites.push(Benchmark.Suite('partially applied call with arguments').add(buildName, {
    'fn': 'lodashPartial("!")',
    'teardown': 'function partial(){}'
  }).add(otherName, {
    'fn': '_partial("!")',
  ...
  suites.push(Benchmark.Suite('`_.partition` iterating an array').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.partition` iterating an object').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.pick`').add(buildName, '\
        lodash.pick(object, "key6", "key13")').add(otherName, '\
        _.pick(object, "key6", "key13")'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.reduce` iterating an array').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.reduce` iterating an object').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.reduceRight` iterating an array').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.reduceRight` iterating an object').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.reject` iterating an array').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.reject` iterating an object').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.sampleSize`').add(buildName, '\
        lodash.sampleSize(numbers, limit / 2)').add(otherName, '\
        _.sampleSize(numbers, limit / 2)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.shuffle`').add(buildName, '\
        lodash.shuffle(numbers)').add(otherName, '\
        _.shuffle(numbers)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.size` with an object').add(buildName, '\
        lodash.size(object)').add(otherName, '\
        _.size(object)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.some` iterating an array').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.some` iterating an object').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.sortBy` with `callback`').add(buildName, '\
        lodash.sortBy(numbers, function(num) { return Math.sin(num); })').add(otherName, '\
        _.sortBy(numbers, function(num) { return Math.sin(num); })'));

  suites.push(Benchmark.Suite('`_.sortBy` with `property` name').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.sortedIndex`').add(buildName, '\
        lodash.sortedIndex(numbers, limit)').add(otherName, '\
        _.sortedIndex(numbers, limit)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.sortedIndexBy`').add(buildName, {
    'fn': '\
  ...
  suites.push(Benchmark.Suite('`_.sortedIndexOf`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.sortedLastIndexOf`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.sum`').add(buildName, '\
        lodash.sum(numbers)').add(otherName, '\
        _.sum(numbers)'));
  ...
  suites.push(Benchmark.Suite('compiled template').add(buildName, {
  ...
  suites.push(Benchmark.Suite('compiled template without a with-statement').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.times`').add(buildName, '\
        var result = [];\
        lodash.times(limit, function(n) { result.push(n); })').add(otherName, '\
        var result = [];\
        _.times(limit, function(n) { result.push(n); })'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.toArray` with an array (edge case)').add(buildName, '\
        lodash.toArray(numbers)').add(otherName, '\
        _.toArray(numbers)'));

  suites.push(Benchmark.Suite('`_.toArray` with an object').add(buildName, '\
        lodash.toArray(object)').add(otherName, '\
        _.toArray(object)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.toPairs`').add(buildName, '\
        lodash.toPairs(object)').add(otherName, '\
        _.toPairs(object)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.unescape` string without html entities').add(buildName, '\
        lodash.unescape("`&`, `<`, `>`, `\\"`, and `\'`")').add(otherName, '\
        _.unescape("`&`, `<`, `>`, `\\"`, and `\'`")'));

  suites.push(Benchmark.Suite('`_.unescape` string with html entities').add(buildName, '\
        lodash.unescape("`&amp;`, `&lt;`, `&gt;`, `&quot;`, and `&#39;`")').add(otherName, '\
        _.unescape("`&amp;`, `&lt;`, `&gt;`, `&quot;`, and `&#39;`")'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.union`').add(buildName, '\
        lodash.union(numbers, twoNumbers, fourNumbers)').add(otherName, '\
        _.union(numbers, twoNumbers, fourNumbers)'));

  suites.push(Benchmark.Suite('`_.union` iterating an array of 200 elements').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.uniq`').add(buildName, '\
        lodash.uniq(numbers.concat(twoNumbers, fourNumbers))').add(otherName, '\
        _.uniq(numbers.concat(twoNumbers, fourNumbers))'));

  suites.push(Benchmark.Suite('`_.uniq` iterating an array of 200 elements').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.uniqBy`').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.values`').add(buildName, '\
        lodash.values(object)').add(otherName, '\
        _.values(object)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.without`').add(buildName, '\
        lodash.without(numbers, 9, 12, 14, 15)').add(otherName, '\
        _.without(numbers, 9, 12, 14, 15)'));

  /*--------------------------------------------------------------------------*/

  suites.push(Benchmark.Suite('`_.wrap` result called').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.zip`').add(buildName, {
...
//# sourceMappingURL=perf-compiled.js.map